...
public class SimpleCompanyWebsite_ProjectController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.Project> { 
public SimpleCompanyWebsite_ProjectController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_SettingsController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.Settings> { 
public SimpleCompanyWebsite_SettingsController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_FrontpageController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.Frontpage> { 
public SimpleCompanyWebsite_FrontpageController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_ArticleController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.Article> { 
public SimpleCompanyWebsite_ArticleController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_BaseItemController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.BaseItem> { 
public SimpleCompanyWebsite_BaseItemController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_EmployeeController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.Employee> { 
public SimpleCompanyWebsite_EmployeeController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_TestimonialController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.Testimonial> { 
public SimpleCompanyWebsite_TestimonialController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_ContactPageController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.ContactPage> { 
public SimpleCompanyWebsite_ContactPageController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_PortfolioController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.Portfolio> { 
public SimpleCompanyWebsite_PortfolioController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
public class SimpleCompanyWebsite_EmployeesPageController : WAF.Server.Controllers.ContentController<WAF.API.SimpleCompanyWebsite.EmployeesPage> { 
public SimpleCompanyWebsite_EmployeesPageController(AdminUIAPIControllerContext ctx) : base(ctx) {    }
}
